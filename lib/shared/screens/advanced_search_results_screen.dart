...
/// KAYAN Screen — Advanced Search
class AdvancedSearchResultsScreen extends ConsumerWidget {
    ...
    return KayanThemedScaffold(
      ...
      body: ListView(
        children: [
          ...
          Text(
            isArabic ? 'نتائج البحث المتقدم' : 'Advanced Search',
