// Unified wishlist — light design (same data as favorites)
...
class UnifiedWishlistScreen extends ConsumerWidget {
  const UnifiedWishlistScreen({super.key});
            ...
            child: productsAsync.when(
              ...
              data: (all) {
                ...
                if (favs.isEmpty) {
                  return Center(
                    child: Text(
                      ar ? 'قائمة الأمنيات فارغة' : 'Your wishlist is empty',
                ...
                return ListView(
                  ...
                  children: favs.map((p) {
                    return KayanClassifiedAdCard(
                      ...
                      locationLine: ar ? 'متجر · خدمات · سوق' : 'Shop · Services · Market',
