...
/// KAYAN Screen — Reschedule Booking
class RescheduleBookingScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return KayanThemedScaffold(
      titleAr: 'إعادة جدولة الحجز',
      titleEn: 'Reschedule Booking',
      body: ListView(
        children: [
          Icon(Icons.layers_outlined, size: 64, color: isDark ? AppColors.skyBlue : AppColors.pepsiBlue),
          const SizedBox(height: 16),
          Text(
            isArabic ? 'إعادة جدولة الحجز' : 'Reschedule Booking',
