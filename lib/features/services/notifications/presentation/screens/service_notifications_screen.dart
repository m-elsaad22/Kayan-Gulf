...
/// KAYAN Screen — Service Notifications
class ServiceNotificationsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return KayanThemedScaffold(
      titleAr: 'إشعارات الخدمات',
      titleEn: 'Service Notifications',
      body: ListView(
        children: [
          Icon(Icons.layers_outlined, size: 64, color: isDark ? AppColors.skyBlue : AppColors.pepsiBlue),
          const SizedBox(height: 16),
          Text(
            isArabic ? 'إشعارات الخدمات' : 'Service Notifications',
